...
class JarvisDesktop:
    ...
    def _answer_worker(self, text: str, images: list[Path]) -> None:
        try:
            ...
            self.root.after(0, lambda error=str(exc): self._answer_done('', error, False))
    ...
    def _mission_worker(self, goal: str) -> None:
        ...
        try:
            ...
            self.root.after(0, lambda error=str(exc): self._mission_done('', error))
    ...
    def _mic_worker(self) -> None:
        try:
            ...
            self.root.after(0, lambda error=str(exc): self._mic_done('', error))
    ...
    def _vision_worker(self, prompt: str) -> None:
        try:
            ...
            self.root.after(0, lambda error=str(exc): self._vision_done('', '', error))
