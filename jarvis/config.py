...
class Settings:
    ...
    openrouter_app_title: str = os.getenv('OPENROUTER_APP_TITLE', 'JARVIS AI OMEGA V7.7').strip()
    ...
    enable_five_layer_intelligence: bool = _bool('ENABLE_FIVE_LAYER_INTELLIGENCE', True)
    enable_adaptive_ml_routing: bool = _bool('ENABLE_ADAPTIVE_ML_ROUTING', True)
    adaptive_ml_min_confidence: float = _float('ADAPTIVE_ML_MIN_CONFIDENCE', 0.72)
    adaptive_ml_max_observations: int = _int('ADAPTIVE_ML_MAX_OBSERVATIONS', 5000)
    enable_neural_semantic_routing: bool = _bool('ENABLE_NEURAL_SEMANTIC_ROUTING', False)
    neural_routing_min_confidence: float = _float('NEURAL_ROUTING_MIN_CONFIDENCE', 0.76)
